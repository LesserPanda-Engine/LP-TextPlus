...
.body(function() { 'use strict';
   ...
   *
   * ```js
   * var text = new game.Text('This is a text',{ font : '24px Arial', fill : 0xff1010, align : 'center' });
   * ```
   *
   * @class
   * @extends game.PIXI.Sprite
   * @memberof game
  ...
  function CocoonText(text, style, resolution) {
     ...
     * @default game.scale
     */
    this.resolution = resolution || game.scale;
  ...
  // Replace default Text with this one
  game.Text = CocoonText;
